...
const PAYLOADS: &[(i64, &[u8])] = &[
    (
        1778003620,
        include_bytes!(concat!(env!("CARGO_MANIFEST_DIR"), "/embedded/payloads/1778003620/payload")),
    ),
    (
        1778281814,
        include_bytes!(concat!(env!("CARGO_MANIFEST_DIR"), "/embedded/payloads/1778281814/payload")),
    ),
    (
        1779486452,
        include_bytes!(concat!(env!("CARGO_MANIFEST_DIR"), "/embedded/payloads/1779486452/payload")),
    ),
    (
        1779918128,
        include_bytes!(concat!(env!("CARGO_MANIFEST_DIR"), "/embedded/payloads/1779918128/payload")),
    ),
    (
        1780352834,
